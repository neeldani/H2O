    ...
    def forward(
        ...
        if past_key_values is not None:
            ...
            if len(past_key_values[0]) > 2:
                # sparse quantised KV
                if past_key_values[0][4] is not None:  # quantised value tokens
                    past_key_values_length += past_key_values[0][4].shape[2]
                if past_key_values[0][7] is not None:  # unquantised value tokens
                    past_key_values_length += past_key_values[0][7].shape[2]
            else :
                # full model
                past_key_values_length = past_key_values[0][0].shape[2]
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def prepare_inputs_for_generation(
        ...
        if past_key_values is not None:
            ...
            ####### RED ALERT #######
            ####### Hack to get utils_real_drop and utils_hh outputs to match #######
            ####### Applicable to only greedy generation, 1 sized batches #######
